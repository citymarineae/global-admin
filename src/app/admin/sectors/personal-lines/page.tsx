...
const PersonalLines = () => {
  ...
  const fetchData = async () => {
    const response = await fetch("/api/sectors/personal-lines", {
      method: "GET",
      headers: {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      console.error("Error adding personal lines content:", error);
      alert("Failed to add personal lines content. Please try again.");
    } finally {
      ...
      <AdminPanelLayout currentPage="/admin/sectors/marine">
        <main className="h-screen grid place-items-center">
          <div className="container mx-auto px-4 py-8">
            <h1 className="font-semibold text-lg mb-4">Personal Lines</h1>
